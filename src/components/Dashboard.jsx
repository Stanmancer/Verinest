                ...
                <div className="p-6 bg-white rounded-2xl shadow-sm border border-slate-200">
                  ...
                  <div className="grid grid-cols-7 gap-3 mb-6">
                    {[1, 2, 3, 4, 5, 6, 7].map((day) => {
                      const isClaimed =
                        ...
                        (day === currentStreak && todayClaimed);
                      const canClaim = day === currentStreak && !todayClaimed;
                      ...
                      return (
                        <div
                          ...
                          onClick={
                            canClaim ? () => claimDailyReward(day) : undefined
                          }
                        >
                  ...
                  <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                    <p className="text-sm text-slate-700 text-center">
                      {todayClaimed ? (
                        <>
                          You've already claimed your reward today. Come back
                          tomorrow!
                        </>
                      ) : currentStreak > 0 ? (
                        <>
                          Click on Day {currentStreak} to claim your{" "}
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 rounded-lg bg-slate-50 gap-2 sm:gap-0 border border-slate-200">
                    ...
                    <button
                      ...
                      disabled={completedMissions.includes("twitter")}
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 rounded-lg bg-slate-50 gap-2 sm:gap-0 border border-slate-200">
                    ...
                    <button
                      ...
                      disabled={completedMissions.includes("quiz")}
                      className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap ${
